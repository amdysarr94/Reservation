...
@section('content')
    <div class="container">
        <form method="post" action="{{route('updateSaveEvent', $event->id)}}" enctype="multipart/form-data">
        @csrf 
        <input type="hidden" value="{{$event->association_id}}" name="idassos">
        <div class="form-group">
            <label for="nom" class="form-label mt-4">Libellé de l'événement</label>
            <input type="text" class="form-control" id="nom" value="{{$event->libelle}}" aria-describedby="emailHelp" placeholder="" name="libelle">
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" name="date_limit" value="{{$event->date_limit}}">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="nom" value="{{$event->description}}" aria-describedby="emailHelp" placeholder="" name="description">
        ...
        <div class="form-group">
            <label for="exampleSelect1" class="form-label mt-4">Est clôturé ou pas ?</label>
                <select class="form-select" id="exampleSelect1" name="isClose" value="{{$event->isClose}}">
                    <option>Oui</option>
                    <option>Non</option>
                </select>
            </div>
        ...
        <div class="form-group">
            ...
            <input type="datetime-local" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" name="date_event" value="{{$event->date_event}}">
