...
Route::middleware('ClientMiddleware')->group(function () {
   ...
   Route::get('/client/reservation/',[ReservationController::class, 'evenement'])->name('homeClient');
});
Route::middleware('check.association')->group(function () {
    ...
    Route::post('/reservation/deny/{reservation}', [ReservationController::class, 'reserveUpdate'])->name('reservationDeny');
